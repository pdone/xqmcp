...
def get_index_basic_info(index_code: str) -> dict:
    ...
    return safe_call(pysnowball.index_basic_info, index_code)
...
def get_index_details_data(index_code: str) -> dict:
    ...
    return safe_call(pysnowball.index_details_data, index_code)
...
def get_index_weight_top10(index_code: str) -> dict:
    ...
    return safe_call(pysnowball.index_weight_top10, index_code)
...
def get_index_perf_7(index_code: str) -> dict:
    ...
    return safe_call(pysnowball.index_perf_7, index_code)
...
def get_index_perf_30(index_code: str) -> dict:
    ...
    return safe_call(pysnowball.index_perf_30, index_code)
...
def get_index_perf_90(index_code: str) -> dict:
    ...
    return safe_call(pysnowball.index_perf_90, index_code)
